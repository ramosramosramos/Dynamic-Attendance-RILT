...
export default function Bin({ teachers, filters }) {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        ...
                        <div className="p-6 text-gray-900 flex flex-wrap gap-5 items-center max-sm:justify-center  sm:justify-center md:justify-center lg:justify-start">
                            <SearchInput items={teachers.data} url={route('teachers.bin')} filters={filteredArrays} />
                        </div>
                    ...
                    <DefaultPaginator meta={teachers.meta} url={route('teachers.bin')} filters={filteredArrays} />
                </div>
            </div>
        </AuthenticatedLayout>
    );
